...
public class MyDictionary<K, V> implements MyIDictionary<K, V> {
    private Map<K, V> dictionary;// used to store the key-value pairs
    ...
    public String toString() {
        StringBuilder s = new StringBuilder(); // used to store the string representation of the dictionary
