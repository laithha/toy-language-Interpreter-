...
import Model.Sugar;
 ...
 // tests a repo-controller interaction with entities that have a price above 200
public class Main {
    public static void main(String[] args) {
        ...
        Flour f2 = new Flour(100);
        Flour f3 = new Flour(250);
        Flour f4 = new Flour(200);
        Flour f5 = new Flour(230);
        Flour f6 = new Flour(330);

        IEnt entities1[] = { s1, f2, f3, f4, f5, f6 }; // we add them in the repo and then we will read them from the repo and write them in the controller
        ...
        for(int i = 0; i < result.length; i++) { // this for loop will print the result array that contains the entities that have a price above 200
        ...
        for (IEnt entity : entities2) { // this for loop will add the entities in the repo and then in the controller
            controller.writeEntity(entity);
        }
        ...
        controller.deleteEntity(0); // this will delete the entity at position 0
